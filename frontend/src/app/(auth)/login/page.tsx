    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md glass-panel relative z-10">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription>
            Enter your credentials to access StepClaim.
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-[var(--color-foreground)]/60">
            Don't have an account? <Link href="/register" className="text-[var(--color-primary)] hover:underline font-medium">Sign Up</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
