    ...
    <div className="p-6 space-y-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-[var(--color-foreground)]/60">Welcome back! Here's how you're doing this week.</p>
        </div>
        <Link href="/run">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="glass-panel border-l-4 border-l-[var(--color-primary)]">
          ...
          <CardContent>
            <div className="text-3xl font-bold">124.5 km</div>
            <p className="text-xs text-[var(--color-success)] mt-1">+2.4 km from yesterday</p>
          </CardContent>
        </Card>
        ...
        <Card className="glass-panel border-l-4 border-l-yellow-500">
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-[var(--color-foreground)]/60">60%</span>
            </div>
          </CardContent>
        </Card>
      </div>
