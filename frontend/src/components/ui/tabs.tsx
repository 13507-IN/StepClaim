...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-lg bg-white/5 border border-white/5 p-1 text-slate-400 backdrop-blur-md',
      className,
    )}
    {...props}
  />
