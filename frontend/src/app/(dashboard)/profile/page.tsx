...
import { Compass, Footprints, Flame, MapPin, Award, Timer, ShieldAlert, History } from 'lucide-react';
import { motion } from 'framer-motion';

// Registry of all achievements (must match prisma seed data)
const ALL_BADGES = [
  { name: 'First Capture', description: 'Captured your very first hexagonal territory', icon: 'First Capture' },
  ...
  { name: '7 Day Streak', description: 'Maintained your daily movement streak for 7 consecutive days', icon: '7 Day Streak' },
          ...
          <CardContent className="flex flex-col md:flex-row items-center md:items-start gap-5 p-6 relative z-10 text-center md:text-left">
            ...
            <div className="flex-1 min-w-0 space-y-2">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5 font-medium">{data?.user?.email}</p>
              </div>
      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            message="Take your mobile outdoors and start mapping your workouts to track metrics!"
          />
        ) : (
